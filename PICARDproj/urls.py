...
urlpatterns = [
  # url(r'^',include(router.urls)),
   ...
   #url(r'^test/', include('portal.views.test', namespace = 'test')),
    #url(r'^test',include('portal.views.test',name='test'))
    url(r'^$', views.HomePage.as_view(), name="home"),
    url(r'^ourstory',views.ourstory,name="ourstory"),
    url(r'^aboutpicard',views.aboutpicard,name="aboutpicard"),
